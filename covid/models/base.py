    ...
    ***************************************
    ...
    def plot_forecast(self,
        ...
        if scale == 'log':
            ...
            pi_max = onp.maximum(2000, pi_max, 2*median_max)
            bottom, top = ax.get_ylim()
            bottom = 1 if bottom < 1 else bottom
            ax.set_ylim([bottom, pi_max+pi_max*1.25])
        else:
            top = onp.maximum(2*median_max, pi_max)
            top = onp.maximum(2000, top)
            ax.set_ylim([0, top+top*1.25])
